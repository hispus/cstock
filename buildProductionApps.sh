...
[[ -d core-prod-apps ]] || mkdir core-prod-apps
cd core-prod-apps
...
# replace some icons
cp ../../images/dashboard-prod/mipmap-hdpi/* app/src/main/res/mipmap-mdpi/
cp ../../images/dashboard-prod/mipmap-mdpi/* app/src/main/res/mipmap-hdpi/
cp ../../images/dashboard-prod/mipmap-xhdpi/* app/src/main/res/mipmap-xhdpi/
cp ../../images/dashboard-prod/mipmap-xxhdpi/* app/src/main/res/mipmap-xxhdpi/
# build
./gradlew build
cp app/build/outputs/apk/app-debug.apk ../cstock-dashboard-prod.apk
...
# replace some icons
cp ../../images/datacapture-prod/mipmap-hdpi/* dhis2-android-app/src/main/res/drawable-hdpi/
cp ../../images/datacapture-prod/mipmap-mdpi/* dhis2-android-app/src/main/res/drawable-mdpi/
cp ../../images/datacapture-prod/mipmap-xhdpi/* dhis2-android-app/src/main/res/drawable-xhdpi/
cp ../../images/datacapture-prod/mipmap-xxhdpi/* dhis2-android-app/src/main/res/drawable-xxhdpi/
# build
./gradlew build
cp dhis2-android-app/build/outputs/apk/dhis2-android-app-debug.apk ../cstock-resupply-prod.apk
...
# replace some icons
cp ../../images/trackercapture-prod/mipmap-hdpi/* app/src/main/res/drawable-hdpi/
cp ../../images/trackercapture-prod/mipmap-mdpi/* app/src/main/res/drawable-mdpi/
cp ../../images/trackercapture-prod/mipmap-xhdpi/* app/src/main/res/drawable-xhdpi/
cp ../../images/trackercapture-prod/mipmap-xxhdpi/* app/src/main/res/drawable-xxhdpi/
# build
./gradlew build
cp app/build/outputs/apk/app-debug.apk ../cstock-stockout-prod.apk
